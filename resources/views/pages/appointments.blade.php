...
@section('content')
    ...
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-6">
            <h2 class="text-xl text-white font-semibold mb-4 bg-blue-900 py-2 rounded">
                Doctor
            </h2>
        ...
        <div class="mt-6">
            ...
            <form class="bg-gray-200 p-4 rounded-lg">
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="doctor-name" type="text" placeholder="Selected Doctor" readonly>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="appointment-type">
                        Appointment Type
                    </label>
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="appointment-type">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="appointment-time" type="time">
                </div>
