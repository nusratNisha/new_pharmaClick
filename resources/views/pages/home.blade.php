...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">PharmaClick <small>Where health and wellness comes first</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-3 -->
	...
	<div class="col-xl-12">
		...
		<div class="panel panel-inverse" data-sortable-id="table-basic-7">
			<div class="panel-heading">
				<h4 class="panel-title">Pendding Users</h4>
						...
						<tbody>
							...
							<tr>
								...
								<td class="with-btn" nowrap>
									<a href="{{ route('user.approve', ['id' => $user->id]) }}" class="btn btn-sm btn-primary width-60 p-3 m-r-2">Approve</a>
									<a href="{{ route('user.reject', ['id' => $user->id]) }}" class="btn btn-sm btn-white width-60 p-3">Reject</a>
								</td>
							</tr>
							@empty
							<tr>
		...
		<div class="panel panel-inverse" data-sortable-id="index-6">
			...
			<div class="table-responsive">
				<table class="table table-valign-middle table-panel mb-0">
					...
					<tbody>
						<tr>
							<td><label class="label label-danger">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
						...
						<tr>
							<td><label class="label label-warning">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
						...
						<tr>
							<td><label class="label label-success">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
						...
						<tr>
							<td><label class="label label-primary">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
						...
						<tr>
							<td><label class="label label-default">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
						...
						<tr>
							<td><label class="label label-inverse">{{ date('d/m/Y') }}</label></td>
							<td>{{ date('H:i:s') }}</td>
							<td>
